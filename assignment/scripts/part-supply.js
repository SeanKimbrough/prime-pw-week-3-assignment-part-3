...
console.log( ' Array of supplyChanges');
...
console.log( ' added 25 to the end of the array' , supplyChanges);
...
console.log(`Total Parts Available is: ${totalParts}`);
...
let boxCapacity = 7;
let boxesFilled = 0;
    while(warehouseParts >= boxCapacity){
        warehouseParts -= boxCapacity;
        warehouseParts++;
    }
